...
public class MakePx {
	...
	private final static float dw = 414f;// 320 1单位长度=1px 640px ,1单位长度=2px
	private final static float dh = 736f;
//	private final static float dw = 375f;// 320 1单位长度=1px 640px ,1单位长度=2px
//	private final static float dh = 667f;
